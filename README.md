...
<p align="center">
   A GitHub Action for creating GitHub or Gitea releases on Linux, Windows, and macOS virtual environments
</p>
...
This action auto-detects Gitea when it is running against a Gitea API endpoint.
GitHub-only inputs such as `generate_release_notes`, `discussion_category_name`,
and `make_latest` are ignored on Gitea.
...
| `server_url`               | String  | Base server URL for GitHub Enterprise or Gitea, such as `https://ghe.example.com` or `https://gitea.example.com`. When omitted, the action uses the runner-provided GitHub API URL.                                                                                                                                                                                                                                                                                    |
